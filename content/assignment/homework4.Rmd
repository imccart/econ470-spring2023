...
# Instructions
In this assignment, you'll again work with the Medicare Advantage data. These data are described in detail in the [Medicare Advantage GitHub Repo](https://github.com/imccart-class/ma). We worked with a subset of these data back in assignment 1; however, this assignment requires that you work with a more complete version of the Medicare Advantage data, but for fewer years. Once you have the data downloaded and the code running, answer the following questions:
