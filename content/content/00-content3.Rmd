...
In part 3, we'll introduce and practice many of the basic data management tools you'll need throughout the class.
...
- Clone [Medicare Advantage repository](https://github.com/imccart-class/ma) and begin working with data 
